  ...
  const insights = [
    {
      ...
      icon: "📈",
      message:
        "গত সপ্তাহে বৃহস্পতিবার সবচেয়ে বেশি বিক্রয় হয়েছে। বৃহস্পতিবারে বিশেষ অফার দিলে বিক্রয় ২৫% বাড়তে পারে।",
      impact: "উচ্চ",
      actionable: true,
    ...
    },
    {
      ...
      icon: "💰",
      message:
        "ডালের দাম বাড়ছে। এখন মজুদ করলে পরে ভালো দামে বিক্রয় করতে পারবেন। ৩০০০ টাকা বিনিয়োগে ৫০০০ টাকা লাভ সম্ভব।",
      impact: "মাঝারি",
      actionable: true,
    ...
    },
    {
      ...
      icon: "💡",
      message:
        "আপনি যে ট্রাক থেকে পণ্য আনেন, সেখানে একসাথে বেশি নিলে পরিবহন খরচ ৪০% কমবে। পাশের দোকানের সাথে মিলে অর্ডার দিন।",
      impact: "মাঝারি",
      actionable: false,
      action: "",
    },
      ...
      <header className="page-header">
        <div className="header-content">
          ...
          <p className="page-subtitle">
            আপনার ব্যবসা সম্পর্কে সহজ ভাষায় বুঝুন
          </p>
        </div>
      </header>
      ...
      <section className="munshiji-greeting">
        <div className="greeting-card">
          ...
          <div className="greeting-content">
            <h2 className="greeting-title">আজকের হিসাব দেখি...</h2>
            <p className="greeting-message">
              আপনার ব্যবসা ভালো চলছে। আজ আমি তিনটি গুরুত্বপূর্ণ বিষয় লক্ষ করেছি
              যা জানা দরকার। এগুলো সহজ ভাষায় বুঝিয়ে দিচ্ছি।
            </p>
          </div>
        </div>
      </section>
          ...
          {insights.map((insight, index) => (
            <div key={index} className="insight-card">
              <div className="insight-header">
                ...
                <div
                  className={`impact-badge ${getImpactColor(insight.impact)}`}
                >
            ...
            <div className="step-card">
              ...
              <div className="step-content">
                ...
                <p className="step-text">
                  আপনার বিক্রয়, মজুদ, পেমেন্ট - সব তথ্য বিশ্লেষণ করে
                </p>
              </div>
            </div>
            <div className="step-card">
              ...
              <div className="step-content">
                ...
                <p className="step-text">
                  কোন দিন বেশি বিক্রয়, কোন পণ্য বেশি চলে - এসব দেখে
                </p>
              </div>
            </div>
            <div className="step-card">
              ...
              <div className="step-content">
                ...
                <p className="step-text">
                  জটিল ডেটা সহজ ভাষায় বুঝিয়ে কী করতে হবে বলে দেয়
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="tips-list">
            ...
            <div className="tip-item">
              ...
              <p className="tip-text">
                নিয়মিত হিসাব রাখুন - AI আরও ভালো পরামর্শ দেবে
              </p>
            </div>
          </div>
        </div>
